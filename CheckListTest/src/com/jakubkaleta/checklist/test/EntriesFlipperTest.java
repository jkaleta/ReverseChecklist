...
public class EntriesFlipperTest extends ActivityInstrumentationTestCase2<EntriesFlipper>
{
	...
	{
		super(TARGET_PACKAGE_ID, EntriesFlipper.class);
	}
	...
	{		
		solo
				.assertCurrentActivity("Program should be open on EntriesFlipper",
						EntriesFlipper.class);
	 ...
	 * category
	 *
	public void testSwipeLeftAndSwipeRight_SwitchingCategories_MultipleCategories()
	{
		setUpTwoCategoriesWithOneItemEach();
		
		solo.drag(150, 450, 350, 345, 1);
		verifyCategorySwitch("Category 1", "Item 2");
		solo.drag(150, 450, 350, 345, 1);
		verifyCategorySwitch("Category 2", "Item 1");
	}*/
	...
	/**
	 * Changing screen orientation should resume the right state
	 * The state consists of List, Category and mode. 
	 * Verifying the list and category is done through checking if the right
	 * item shows up. 
	 * Verifying mode is done through calling the private helper method isInToDoMode
	 */
	 ...
	 * In To-do mode items do not have context menu.
	 * In Edit mode, there are checkboxes visible.
	 */
	...
	/**
	 * Clicking ManageCategories should open the CategoryList activity.
	 * The activity is not expected to produce a result. 
	 */
	...
	/**
	 * Pressing All lists should take the user back to the home screen
	...
	public void testMenu_ClearAllItemsFromTheList_ToDoMode()
	{
		...
		// at this point, the list should be removed from the screen, the remaining list
		// list one, should have two items in it. Buttons for switching back and forward
		// should be disabled. 
		assertTrue(solo.searchText("Item 1"));
	...
	/**
	 * Tests that in edit mode, when there are selected items,
	 * Clear list menu item is enabled, otherwise it is disabled.
	 */

...
public class ActivityList extends ListActivity
{
	...
	{ ActivityColumns.ACTIVITY_NAME, ActivityColumns.ITEM_COUNT,
	...
	public void onCreate(Bundle savedInstanceState)
	{
		...
		ArrayAdapter<CharSequence> adapter = ArrayAdapter.createFromResource(this,
				R.array.sort_options_for_activity_list, android.R.layout.simple_spinner_item);
	...
	private void saveState()
	{
		...
		values.put(AppStateColumns.ACTIVITY_LIST_SORT_ORDER, ActivityListSortOrder.fromNumber(
				sortOptionsSpinner.getSelectedItemPosition()).toNumber());
			...
			activityListAdapter.setViewBinder(new SimpleCursorAdapter.ViewBinder()
			{
				...
				public boolean setViewValue(View view, Cursor cursor, int column)
				{
					...
					case 1:
						...
						int selectedItemsCount = cursor.getInt(cursor
								.getColumnIndex(ActivityColumns.SELECTED_ITEM_COUNT));
						int allItemsCount = cursor.getInt(cursor
								.getColumnIndex(ActivityColumns.ITEM_COUNT));
						...
						if (allItemsCount > 0)
						{
							...
							text = String.format(resources.getString(R.string.item_counts),
					...
					case 2:
						...
						String dateCreated = cursor.getString(cursor
								.getColumnIndex(ActivityColumns.DATE_CREATED));
	...
	private final void deleteActivity(Uri uriToDelete)
	{
		...
		dialogBuilder.setTitle(R.string.remove_activity).setMessage(
				R.string.confirm_permanent_deletion_of_list).setPositiveButton(R.string.yes_string,
	...
	public boolean onOptionsItemSelected(MenuItem item)
	{
		...
		case R.id.menu_activity_list_about:
			final AlertDialog.Builder dialogBuilder = new AlertDialog.Builder(this);
			dialogBuilder.setTitle(R.string.app_name).setMessage(R.string.questions_suggestions)
					.setIcon(R.drawable.appicon).setCancelable(true).setNeutralButton(
							R.string.ok_string, null).show();
			return true;
	...
	protected void onActivityResult(int requestCode, int resultCode, Intent data)
	{
		if (resultCode == RESULT_OK)
		{
			...
			case UPDATED_ACTIVITY:
				...
				values.put(ActivityColumns.ACTIVITY_NAME, e
						.getString(ActivityColumns.ACTIVITY_NAME).trim());

				getContentResolver().update(
						ContentUris.withAppendedId(ActivityColumns.CONTENT_URI, e
								.getLong("activityId")), values, null, null);
				break;
